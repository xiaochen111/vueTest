<template>
  <div class="containerBox">
      {{tab}}
      <div class="ssq">
          <input type="text" placeholder="省区市" v-model="areaString">
          <div class="dropBox">
              <ul class="tab">
...
<style lang="less" scoped>
    ...
    .containerBox{
        width: 1200px; margin: 0 auto; height: 500px;
        .ssq{
            ...
            .dropBox{
                .pos_a(); top: 35px; left: -1px; .border();.boxsize();padding:10px; width: calc(~"120% + 2px");
            }
            .tab{
                .lh(30px); .bor_b();
                li{
